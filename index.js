...
\n\n\n <b>Arrival:</b> \n\n<table style="width:100%"><tr><td>${scheduleda.substring(0, scheduleda.length-4)} \n\n<i>Est:</i>\n${estimateda.substring(0, estimateda.length-4)}</td><td><b style="font-size:32px"><img src="https://drive.google.com/open?id=0B6eOn0z2jt_jLXJhaEh0VEM1TTA"/></b></td></tr></table>`)
