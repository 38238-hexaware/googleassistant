...
\n\n\n <b>Arrival:</b> \n\n<table style="width:100%"><tr><td>${scheduleda.substring(0, scheduleda.length-4)} \n\n<i>Est:</i>\n${estimateda.substring(0, estimateda.length-4)}</td><td><iframe src="https://drive.google.com/file/d/0B6eOn0z2jt_jc2FkUEJnNmtSZzg/preview" width="640" height="480"></iframe></td></tr></table>`)
