...
<p align="center">${airports}<p>\n<b>Arrival:</b><table width="100%"><tr><td align="left">${scheduleda.substring(0, scheduleda.length-4)} <br/><i>Est:</i>${estimateda.substring(0, estimateda.length-4)}</td><td><img src="https://www.dropbox.com/s/mcw8pgxq5akdn0v/rsz_arrival.png?raw=1"/></td></tr></table><p  align="center">${airportd}<p>`)
