...
//===========================================                                
  app1.askWithList(app1.buildRichResponse()
    ...
    .addItems(app1.buildOptionItem('option5').setTitle(` `).setImage(`https://maps.googleapis.com/maps/api/staticmap?center=40.714728,-73.998672&zoom=10&size=200x200&maptype=roadmap&markers=anchor:topleft%7Cicon:https://www.dropbox.com/s/coom3cu3rdijeby/rsz_1rsz_airplane-512.png?raw=1%7C40.714728,-73.998672&key=AIzaSyCsB3zqvC5gR7LrAG7_kyiBkk17dQiFUes`))                 
