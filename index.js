...
app1.ask(app1.buildRichResponse()
    ...
    .addBasicCard(app1.buildBasicCard(`<center><b> ${sourcecarrier} => ${destcarrier} </b></center><table style="width:100%"><tr><td align="left"><b>Departure:</b> \n\n${datedep}\n\n${scheduledd.substring(0, scheduledd.length-4)}\n\nEst:\n${estimatedd.substring(0, estimatedd.length-4)}</td><td  align="left"><img src="https://www.dropbox.com/s/l1h4x5r6ox5f60q/rsz_departure.png?raw=1"/></td></table>
\n\n\n <b>Arrival:</b> \n\n<table style="width:100%"><tr><td  align="left">${scheduleda.substring(0, scheduleda.length-4)} \n\n<i>Est:</i>\n${estimateda.substring(0, estimateda.length-4)}</td><td  align="left"><img src="https://www.dropbox.com/s/mcw8pgxq5akdn0v/rsz_arrival.png?raw=1"/></td></tr></table>`)
